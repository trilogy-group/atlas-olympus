...
import { Box, Button, IconButton, Typography, useTheme, Accordion, AccordionSummary, AccordionDetails, Grid } from "@mui/material";
...
const Dashboard = () => {
  ...
  const totalSlaFailuresGrid = 4;
  const totalStatusGraphicGrid = 8;
  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        <Header 
          title={`UNDER CONSTRUCTION - UNDER CONSTRUCTION - UNDER CONSTRUCTION - UNDER CONSTRUCTION`} 
          subtitle={`UNDER CONSTRUCTION - UNDER CONSTRUCTION - UNDER CONSTRUCTION - UNDER CONSTRUCTION ${(dataMatrix.length > 3) ? `(Last updated: ${dataMatrix[1][20].split('T')[0]} - ${dataMatrix[1][20].split('T')[1].split('.')[0]} GMT)` : ''}`} 
          />
      ...
      >
        ...
        >
          ...
          >
            ...
            Leaderboard {`- ${dataMatrixSLA.length} Tickets`}
            </Typography>
          </Box>
        ...
        <Box m="20px">
          ...
          {/* Renderización del acordeón de usuarios */}
            ...
            <AccordionDetails>
              <Grid container spacing={2}>
                  <Grid item xs={12} sm={6} md={4} lg={3} key={1}>
                    <Typography variant="body1" style={{ color: colors.blueAccent[400] }}>
                      Whatever3
                    </Typography>
